...
import com.weibo.R;
import com.weibo.adapters.FaceAdapter;
import com.weibo.adapters.ViewPagerAdapter;
...
public class FaceRelativeLayout extends RelativeLayout implements
	...
	private static final String TAG = "FaceRelativeLayout.java";
	...
	protected void onFinishInflate() {
		...
		onCreate();
		Log.d(TAG, "back to FaceRelativeLayout.java");
	}
	...
	public void onClick(View v) {
		...
		case R.id.button_clear:
			DialogUtils.dialogBuilder((Activity) context, "提示", "确定要清除微博吗？",
					new DialogCallBack() {
						@Override
	...
	private void Init_View() {
		...
		et_sendmessage = (EditText) findViewById(R.id.share_content);
		if (et_sendmessage == null) {
			et_sendmessage = (EditText) findViewById(R.id.editText2);
		}
		layout_point = (LinearLayout) findViewById(R.id.iv_image);
		et_sendmessage.setOnClickListener(this);
		findViewById(R.id.biaoqingbtn).setOnClickListener(this);
	...
	private void textCountSet() {
		String textContent = et_sendmessage.getText().toString();
